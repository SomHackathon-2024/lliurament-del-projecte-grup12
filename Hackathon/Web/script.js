...
function inicio() {
  ...
  function open() {
    for (let k = 0; k <= 18; k++) {
        document.querySelector("#caja2").innerHTML += `<div class="cuadro2"><img src="https://www.inspain.org/imgwbp/playas/0/4/4/lkkefr2vzs7id7g4vnxmbcepzu_2000.webp" alt="" height: 125px width: 150px></div>`;
        // document.querySelector("#caja").innerHTML += `<div class="cuadro">${k}</div>`;
    }
